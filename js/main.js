...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    requestAnimationFrame(updatePizzaSizes);
...
function updatePositions() {
  ...
  requestAnimationFrame(updatePositionsStyling);

  function updatePositionsStyling() {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Calculates the number of needed pizzas and rounds the number up to neares whole number
  var numberOfPizzas = Math.ceil(cols * window.innerHeight / pizzaHeight);
